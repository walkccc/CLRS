...
1. Original heap.
    ...
    ![](https://i.imgur.com/NqqRT33.png?width=30rem)

2. Extract the max node $15$, then move $1$ to the top of the heap.

    ![](https://i.imgur.com/MshRmIP.png?width=30rem)

3. Since $13 > 9 > 1$, swap $1$ and $13$.

    ![](https://i.imgur.com/vnv3eBS.png?width=30rem)

4. Since $12 > 5 > 1$, swap $1$ and $12$.

    ![](https://i.imgur.com/CyAYUaT.png?width=30rem)

5. Since $6 > 2 > 1$, swap $1$ and $6$.

    ![](https://i.imgur.com/6YvV19t.png?width=30rem)
