...
Consider the tree $T'$ formed by removing the leaves of $T$. It has $n' = n - n_0$ nodes. We know from the base case that $n_0' = \lceil n / 2 \rceil$, so $n' = n - n_0 = n - \lceil n / 2 \rceil$.
