...
>
> Given $m \le n^2$ starting points $(x\_1, y\_1), (x\_2, y\_2), \ldots, (x\_m, y\_m)$ in the grid, the __*escape problem*__ is to determine whether or not there are $m$ vertex-disjoint paths from the starting points to any $m$ different points on the boundary. For example, the grid in Figure 26.11(a) has an escape, but the grid in Figure 26.11(b) does not.
>
