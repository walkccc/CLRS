...
```
>
> **a.** Let $A^\prime$ denote the output of $\text{BUBBLESORT}(A)$ To prove that $\text{BUBBLESORT}$ is correct, we need to prove that it terminates and that
>
> <div>
> $$
> A^\prime[1] \le A^\prime[2] \le \cdots \le A^\prime[n], \tag{2.3}
> $$
> </div>
>
...
**a.** We need to show that the elements of $A^\prime$ form a permutation of the elements of $A$.
